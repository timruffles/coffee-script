(function() {
  ...
  exports.Op = Op = (function() {
    ...
    Op.prototype.isComparison = function() {
      var _ref2;
      return (_ref2 = this.operator) === '<' || _ref2 === '>' || _ref2 === '>=' || _ref2 === '<=' || _ref2 === '===' || _ref2 === '!==' || _ref2 === '<=>';
    };
    ...
    Op.prototype.compileNode = function(o) {
      ...
      code = this.isComparison() ? utility("comparison") + "(" + this.first.compile(o, LEVEL_OP) + ", " + this.second.compile(o, LEVEL_OP) + (", '" + this.operator + "')") : this.first.compile(o, LEVEL_OP) + ' ' + this.operator + ' ' + this.second.compile(o, LEVEL_OP);
      if (o.level <= LEVEL_OP) {
        return code;
      } else {
        return "(" + code + ")";
